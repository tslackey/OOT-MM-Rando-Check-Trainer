...
- `src/logic/oracle.test.ts` — masks, windmill SoS, closed forest, Forest lobby, KF sword, Gohma forest escape, DoT, night GS, either-age flag, Epona valley, imported bridge/LACS/Ganon BK, Shuffle Open Chest
