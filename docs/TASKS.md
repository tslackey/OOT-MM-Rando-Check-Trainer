...
| --- | --- | --- | --- | --- | --- | --- |
| L-DOC | This board + `AGENTS.md` pointer | claimed | cloud agent | [bc-01a082f5…](https://cursor.com/agents/bc-01a082f5-fb67-7db6-9d83-6d31bb1c7598) | `cursor/logic-task-board-7598` | Land first so other agents can claim |
| L-A | Wrap `@mracsys/randomizer-graph-tool` as the penalty backend | claimed | cloud agent | [bc-01a082f5…](https://cursor.com/agents/bc-01a082f5-fb67-7db6-9d83-6d31bb1c7598) | `cursor/tracker-graph-wrap-7598` (opening next) | Parent of A1–A5. Same agent. Do not start a second wrap. |
| L-A1 | Pin the npm package; feed vendored `src/data/ootr/` as `ExternalFileCache` (no GitHub fetch) | claimed | cloud agent | [bc-01a082f5…](https://cursor.com/agents/bc-01a082f5-fb67-7db6-9d83-6d31bb1c7598) | same as L-A | |
